...
const ButtonLogout = () => {
    ...
    return (
        <div>
            <button 
            onClick={openMoreAccount} 
            className="flex gap-2 py-2 px-4 rounded text-white bg-gray-700 hover:bg-gray-200 hover:text-gray-700 transition-all ease-in duration-200">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`w-6 h-6`}>
                ...
                <svg id="svg-logout-arrow" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`w-6 h-6 global-transition ${moreActive ? 'rotate-180' : ''}`}>
            ...
            <div className="w-full">
                <ul className={`z-10 absolute flex flex-col overflow-hidden border-gray-200 bg-gray-700 ml-0 mt-1 rounded text-right global-transition ${moreActive ? "max-h-52" : "max-h-0"}`} >
                    ...
                    <li 
                    className="cursor-pointer flex gap-2 hover:bg-gray-200 hover:text-gray-700 global-transition px-8 py-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
